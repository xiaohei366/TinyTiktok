...
func (x *DouyinPublishActionRequest) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 4, x.User)
	return offset
}
...
var _ = UserServer.File_UserServer_proto
var _ = FeedServer.File_FeedServer_proto
